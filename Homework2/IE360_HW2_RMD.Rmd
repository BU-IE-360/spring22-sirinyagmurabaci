...
##   6. Appendices
[Here](https://bu-ie-360.github.io/fall20-nilufercetin/files/HMW3.Rmd) RMD file written for this assignment including the code chunks can be found.

[Here](https://bu-ie-360.github.io/fall20-araldortogul/files/R-scripts/homework3.R) (.R file). All the R code written can be found. 
